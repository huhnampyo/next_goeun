        ...
        <form>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              ...
              <li><label htmlFor="시스템 설정 코드">시스템 설정 코드</label><input type="text" id="시스템 설정 코드" name="시스템 설정 코드" defaultValue="ART" />
              </li>
            </ul>
          </div>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              ...
              <li><label htmlFor="고객코드">고객코드</label><input type="text" id="고객코드" name="고객코드" defaultValue="108-81-85184" />
              </li>
              <li><label htmlFor="우편번호">우편번호</label><input type="text" id="우편번호" name="우편번호" defaultValue="06106" /></li>
              <li><label htmlFor="고객주소1">고객주소1</label><input type="text" id="고객주소1" name="고객주소1" defaultValue="서울특별시 강남구" />
              </li>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              ...
              <li><label htmlFor="이름(마스터)">이름(마스터)</label><input type="text" id="이름(마스터)" name="이름(마스터)" defaultValue="홍길동" />
              </li>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              <li><label htmlFor="견적번호">견적번호</label><input type="text" id="견적번호" name="견적번호" defaultValue="6006277524" /></li>
              <li><label htmlFor="견적구분">견적구분</label><input type="text" id="견적구분" name="견적구분" defaultValue="서비스료 변경" /></li>
              <li><label htmlFor="견적상태">견적상태</label><input type="text" id="견적상태" name="견적상태" defaultValue="견적" /></li>
              <li><label htmlFor="주장치코드">주장치코드</label><input type="text" id="주장치코드" name="주장치코드" defaultValue="CNT10006" />
              </li>
              ...
              <li><label htmlFor="오퍼링_3">오퍼링</label><input type="text" id="오퍼링_3" name="오퍼링_3" defaultValue="영상 > 영상_일반 > -" />
              </li>
              ...
              <li><label htmlFor="변경 후 계약기간">변경 후 계약기간</label><input type="text" id="변경 후 계약기간" name="변경 후 계약기간" defaultValue="36개월" />
              </li>
              <li><label htmlFor="출동료">출동료</label><input type="text" id="출동료" name="출동료" defaultValue="-" /></li>
            </ul>
          </div>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              <li><label htmlFor="방범서비스(대인)">방범서비스(대인)</label><input type="text" id="방범서비스(대인)" name="방범서비스(대인)" defaultValue="-" />
              </li>
              <li><label htmlFor="방범서비스(대물)">방범서비스(대물)</label><input type="text" id="방범서비스(대물)" name="방범서비스(대물)" defaultValue="-" />
              </li>
              <li><label htmlFor="스페셜보험">스페셜보험</label><input type="text" id="스페셜보험" name="스페셜보험" defaultValue="-" /></li>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              <li><label htmlFor="변경 후 월 서비스료">변경 후 월 서비스료</label><input type="number" id="변경 후 월 서비스료" name="변경 후 월 서비스료"
                  defaultValue="48000" /></li>
              <li><label htmlFor="견적 설치비용">견적 설치비용</label><input type="number" id="견적 설치비용" name="견적 설치비용" defaultValue="0" />
              </li>
              <li><label htmlFor="계약 설치비용">계약 설치비용</label><input type="number" id="계약 설치비용" name="계약 설치비용" defaultValue="0" />
              </li>
              <li><label htmlFor="할인된 설치비용">할인된 설치비용</label><input type="number" id="할인된 설치비용" name="할인된 설치비용" defaultValue="0" /></li>
              <li><label htmlFor="유보금">유보금</label><input type="number" id="유보금" name="유보금" defaultValue="0" /></li>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              ...
              <li><label htmlFor="마케팅 활용 동의">마케팅 활용 동의</label><input type="text" id="마케팅 활용 동의" name="마케팅 활용 동의" defaultValue="Y" /></li>
              ...
              <li><label htmlFor="제3자 제공 동의 (엘지유플러스)">제3자 제공 동의 (엘지유플러스)</label><input type="text" id="제3자 제공 동의 (엘지유플러스)"
                  name="제3자 제공 동의 (엘지유플러스)" defaultValue="Y" /></li>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              ...
              <li><label htmlFor="납입조건">납입조건</label><input type="text" id="납입조건" name="납입조건" defaultValue="-" /></li>
            </ul>
          </div>
        </form>
      </div>
      <Script id="form-script-3">
        {`
          (() => {
            // ====== 환경 ======
