        ...
        <form>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              ...
              <li><label htmlFor="고객주소1">고객주소1</label><input type="text" id="고객주소1" name="고객주소1" defaultValue="-" /></li>
              <li><label htmlFor="고객주소2">고객주소2</label><input type="text" id="고객주소2" name="고객주소2" defaultValue="-" /></li>
              <li><label htmlFor="고객주소3">고객주소3</label><input type="text" id="고객주소3" name="고객주소3" defaultValue="-" /></li>
            </ul>
          </div>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              <li><label htmlFor="서비스제공처명">서비스제공처명</label><input type="text" id="서비스제공처명" name="서비스제공처명" defaultValue="" /></li>
              <li><label htmlFor="서비스제공처 형태">서비스제공처 형태</label><input type="text" id="서비스제공처 형태" name="서비스제공처 형태" defaultValue="" /></li>
              ...
              <li><label htmlFor="우편번호">우편번호</label><input type="text" id="우편번호" name="우편번호" defaultValue="" /></li>
              <li><label htmlFor="서비스제공처주소1">서비스제공처주소1</label><input type="text" id="서비스제공처주소1" name="서비스제공처주소1" defaultValue="" /></li>
              <li><label htmlFor="서비스제공처주소2">서비스제공처주소2</label><input type="text" id="서비스제공처주소2" name="서비스제공처주소2" defaultValue="" /></li>
              <li><label htmlFor="서비스제공처주소3">서비스제공처주소3</label><input type="text" id="서비스제공처주소3" name="서비스제공처주소3" defaultValue="" /></li>
              <li><label htmlFor="업종">업종</label><input type="text" id="업종" name="업종" defaultValue="커피점" /></li>
            </ul>
          </div>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              <li><label htmlFor="견적번호">견적번호</label><input type="text" id="견적번호" name="견적번호" defaultValue="6007675036" /></li>
              ...
              <li><label htmlFor="오퍼링">오퍼링</label><input type="text" id="오퍼링" name="오퍼링" defaultValue="방범 > 방범_일반 > -" /></li>
              <li><label htmlFor="오퍼링_2">오퍼링</label><input type="text" id="오퍼링_2" name="오퍼링_2" defaultValue="출입 > 출입관리_일반 > -" /></li>
              <li><label htmlFor="오퍼링_3">오퍼링</label><input type="text" id="오퍼링_3" name="오퍼링_3" defaultValue="영상 > 영상_일반 > -" /></li>
              <li><label htmlFor="오퍼링_4">오퍼링</label><input type="text" id="오퍼링_4" name="오퍼링_4" defaultValue="방범 > SMS_세트해제 > -" /></li>
              <li><label htmlFor="오퍼링_5">오퍼링</label><input type="text" id="오퍼링_5" name="오퍼링_5" defaultValue="출입 > 모바일카드 > -" /></li>
              ...
              <li><label htmlFor="계약기간">계약기간</label><input type="text" id="계약기간" name="계약기간" defaultValue="18개월" /></li>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              <li><label htmlFor="방범서비스(대인)">방범서비스(대인)</label><input type="number" id="방범서비스(대인)" name="방범서비스(대인)" defaultValue="2억원" />
              </li>
              <li><label htmlFor="방범서비스(대물)">방범서비스(대물)</label><input type="number" id="방범서비스(대물)" name="방범서비스(대물)" defaultValue="1억원" />
              </li>
            </ul>
          </div>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              <li><label htmlFor="스페셜보험">스페셜보험</label><input type="text" id="스페셜보험" name="스페셜보험"
                  defaultValue="보험 > 스페셜보험 > 스페셜보험_1천만원" /></li>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              <li><label htmlFor="월 서비스료">월 서비스료</label><input type="number" id="월 서비스료" name="월 서비스료" defaultValue="50000" /></li>
              <li><label htmlFor="유보 설치비">유보 설치비</label><input type="number" id="유보 설치비" name="유보 설치비" defaultValue="505996" /></li>
            </ul>
          </div>
          ...
          <div className="section">
            ...
            <ul className="form-list">
              ...
              <li><label htmlFor="예금주(카드주)">예금주(카드주)</label><input type="text" id="예금주(카드주)" name="예금주(카드주)" defaultValue="포앤식스" /></li>
              <li><label htmlFor="계좌(카드)번호">계좌(카드)번호</label><input type="text" id="계좌(카드)번호" name="계좌(카드)번호"
                  defaultValue="1200251203159462" /></li>
              <li><label htmlFor="생년월일(사업자번호)">생년월일(사업자번호)</label><input type="text" id="생년월일(사업자번호)" name="생년월일(사업자번호)"
                  defaultValue="108-81-55551" /></li>
              <li><label htmlFor="카드유효기간">카드유효기간</label><input type="text" id="카드유효기간" name="카드유효기간" defaultValue="08월 29년" /></li>
              ...
              <li><label htmlFor="E-mail 주소">E-mail 주소</label><input type="email" id="E-mail 주소" name="E-mail 주소"
                  defaultValue="mail@forn6.com" /></li>
              ...
              <li><label htmlFor="세금계산서 E-mail">세금계산서 E-mail</label><input type="email" id="세금계산서 E-mail" name="세금계산서 E-mail"
                  defaultValue="bill@forn6.com" /></li>
              <li><label htmlFor="납입조건">납입조건</label><input type="text" id="납입조건" name="납입조건" defaultValue="1개월 선납" /></li>
            </ul>
          </div>

        </form>
      </div>
      <Script id="form-script-7">
        {`
          (() => {
            // ====== 환경 ======
